...
const imgBtnMenu = document.getElementById("btn-menu-img");
...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Marion Durant')
.pauseFor(300)
.typeString(', étudiante Web et Communication Visuelle !')
.pauseFor(1000)
.deleteChars(31)
.typeString('en<strong><span style="color: #9B0909;"> Conception digitale</span></strong> !')
.pauseFor(1000)
.deleteChars(23)
.typeString('<strong><span style="color: #9B0909;"> HTML/CSS</span></strong> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<strong><span style="color: #9B0909;"> Javascript</span></strong> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<strong><span style="color: #9B0909;"> CMS WordPress</span></strong> !')
.start();
